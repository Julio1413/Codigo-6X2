...
* `meiadouze` - project name - lowercase, no spaces, i.e. "snake_case" identifier - used as a package name, iOS/macOS/Android bundle name and Windows/Linux executable file name.
* `` - project description.
* `MeiaDouze` - project display name that is shown in window titles and about app dialogs.
* `com.cubepy.MeiaDouze` - org name in reverse domain name notation, e.g. `com.mycompany.myproject`.
* `Cubepy` - the name of the company.
* `Copyright (C) 2025 by Cubepy` - the name of the company.
